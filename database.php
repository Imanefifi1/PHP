...
//call the createDatabase methods to create database "POOphp4"
$connection->createDatabase('POOphp4');
...
//call the selectDatabase method to select the POOPhp
$connection->selectDatabase('POOphp4');
